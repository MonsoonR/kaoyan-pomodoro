...
CREATE TABLE `__new_sync_operations` (
	...
	CONSTRAINT "sync_operations_status_check" CHECK("__new_sync_operations"."status" IN ('applied', 'duplicate', 'conflict')),
